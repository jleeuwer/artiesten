...
async function createMember(req,res){res.status(201).json(await service.createMember(req.body));}
async function createMemberFromArtist(req,res){res.status(201).json(await service.createMemberFromArtist(req.body));}
...
module.exports={listForArtist,get,searchMusicians,create,createMember,createMemberFromArtist,update,remove};
