...
function normalizeMembershipPayload(body = {}, { requireReferences = true } = {}) {
  const musicianKey = requireReferences ? positiveInteger(body.musicianKey, "musicianKey") : (body.musicianKey ? positiveInteger(body.musicianKey, "musicianKey") : null);
  const bandArtistKey = requireReferences ? positiveInteger(body.bandArtistKey, "bandArtistKey") : (body.bandArtistKey ? positiveInteger(body.bandArtistKey, "bandArtistKey") : null);
